  ...
  return (
    ...
    {props.state.current===1&&props.state.current1===2&&<div className='title'>
      ...
      <div style={{flex:'1',overflow:"scroll",position:'relative'}}  className='qwe'>
        <div style={{width:`${ri.length*72}px`,position:'absolute',height:`${props.state.List.length*40+8}px`}}>  
     ...
     <div style={{flex:'1',overflow:"scroll",position:'relative'}} className='qwe1'>
      <div style={{width:`${weekdayri.length*72}px`,height:`${props.state.List.length*40+8}px`,position:'absolute',}}>  
    ...
    }
    {
      ...
      <div style={{flex:'1',overflow:"scroll",position:'relative'}}  className='qwe3'>
        <div style={{width:`${zhou.length*240}px`,height:`${props.state.List.length*40+8}px`,position:'absolute'}}>  
     ...
     <div style={{flex:'1',overflow:"scroll",position:'relative'}} className='qwe4'>
      <div style={{width:`${(year.length+1)*365*24}px`,height:`${props.state.List.length*40+8}px`,position:'absolute'}}>  
    ...
    {props.state.current===3&&props.state.current1===1&&<div className='title'>
      ...
      <div style={{flex:'1',overflow:"scroll",position:'relative'}}   className='qwe5'>
        <div style={{width:`${year.length*(365-96)*24}px`,height:`${props.state.List.length*40+8}px`,position:'absolute'}}>  
